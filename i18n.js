(function () {
  ...
  const translations = {
    ar: {
      ...
      "privacy.google": "خدمات Google وAdSense/AdMob لعرض الإعلانات وقياس الأداء.",
    ...
    en: {
      ...
      "privacy.google": "Google services and AdSense/AdMob for ad delivery and performance measurement.",
    ...
    fr: {
      ...
      "privacy.google": "Services Google et AdSense/AdMob pour la diffusion d'annonces et la mesure des performances.",
